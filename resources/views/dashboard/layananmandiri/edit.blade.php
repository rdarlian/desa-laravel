...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Edit Layanan Mandiri</h1>
</div>
...
<form method="post" action="/dashboard/layanan/{{ $layanan->id }}" class="mb-5" enctype="multipart/form-data">
    ...
    @csrf
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" required autofocus value="{{ old('name', $layanan[{{ layananmandiri->layanan_id }}]->name)  }}">
