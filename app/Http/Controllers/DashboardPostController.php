...
class DashboardPostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('image')) {
            ...
            $request->image->move(public_path('post-images'),$newImageName);
    ...
    public function update(Request $request, Post $post)
    {
        ...
        if($request->file('image')) {
            File::delete( public_path('post-images/'. $request->oldImage) );
    ...
    {
        if($post->image){
            File::delete( public_path('post-images/'. $post->image) );
        }
